...
import idbroker.provisioning_api.models
from idbroker.provisioning_api import rest
from idbroker.provisioning_api.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(idbroker.provisioning_api.models, klass)
