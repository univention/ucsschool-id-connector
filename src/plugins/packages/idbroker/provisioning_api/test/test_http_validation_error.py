...
from idbroker.provisioning_api.models.http_validation_error import HTTPValidationError  # noqa: E501
...
class TestHTTPValidationError(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = idbroker.provisioning_api.models.http_validation_error.HTTPValidationError()  # noqa: E501
        if include_optional :
            return HTTPValidationError(
                detail = [
                    idbroker.provisioning_api.models.validation_error.ValidationError(
                        loc = [
                            ''
                            ], 
                        msg = '', 
