...
You need to install the |IDC| app through the appcenter on your development vm.
...
Some of the default plugins are only used if not custom plugins are present:
